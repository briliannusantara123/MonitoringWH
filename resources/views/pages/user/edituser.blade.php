@include('layouts.header')
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
              ...
              <div class="container-fluid py-4">
                ...
                <div class="mb-3">
                  ...
                  <small style="color: red;">*Leave blank if you do not wish to change the password</small>
                </div>
                <div class="mb-3">
                              ...
                              <div class="row">
                                  @foreach($p['group'] as $group)
                                      ...
                                      @foreach($userpermission as $user)
                                          @if($user->permission_id == $group['id'])
                                              @php
                                                  $checked = 'checked';
                                              @endphp
                                          @endif
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Initialize: ensure child checkboxes start as enabled or checked if already selected
